...
const items: BrandMenuItem[] = [
  { key: "prompts", label: "Prompti", paid: false, href: (brandId) => `/app/brands/${brandId}/prompts` },
  { key: "competitors", label: "Konkurenti", paid: true, href: (brandId) => `/app/brands/${brandId}/competitors` },
  { key: "citations", label: "Citati", paid: true, href: (brandId) => `/app/brands/${brandId}/citations` },
  { key: "actions", label: "Akcijski center", paid: true, href: (brandId) => `/app/brands/${brandId}/actions` }
];
      ...
      {items.map((item) => {
        ...
        return (
          <Link
            ...
            href={locked ? `/app/brands/${brandId}/paywall?feature=${item.key}` : item.href(brandId)}
          >
            {item.label}
